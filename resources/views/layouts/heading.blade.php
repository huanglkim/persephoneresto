<div class="invoice-header" style="display: flex; align-items: center; border-bottom: 1.5px solid #000; padding-bottom: 10px; margin-bottom: 25px;">
    <div class="logo" style="flex: 0 0 80px;">
        <img src="{{ asset('assets/slider/logo.png') }}" alt="Company Logo" style="max-height: 70px;">
    </div>
